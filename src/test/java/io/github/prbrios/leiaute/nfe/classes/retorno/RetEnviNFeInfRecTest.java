...
import io.github.prbrios.leiaute.nfe.classes.retorno.RetEnviNFeInfRec;
...
public class RetEnviNFeInfRecTest {
    ...
    public static final String XML = "<infRec><nRec>0</nRec><tMed>1</tMed></infRec>";

    @Test
    public void test1() {
        RetEnviNFeInfRec obj = new RetEnviNFeInfRec();
        obj.setnRec("0");
        obj.settMed("1");
